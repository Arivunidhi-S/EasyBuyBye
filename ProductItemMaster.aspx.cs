...
public partial class ProductItemMaster : System.Web.UI.Page
{
    ...
    protected void cboBrand_OnItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        {
            InsertLogAuditTrail(Session["CustomerID"].ToString(), "ProductItemMaster", "cboBrand_OnItemsRequested", ex.ToString(), "Audit");
        }
    }
    ...
    protected void cboModel_OnItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        {
            InsertLogAuditTrail(Session["CustomerID"].ToString(), "ProductItemMaster", "cboModel_OnItemsRequested", ex.ToString(), "Audit");
        }
    }
    ...
    protected void btnAddProduct_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!(string.IsNullOrEmpty(FileImage1.FileName.ToString())))
            {
                ...
                downfile = cboBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + cboModel.SelectedValue.ToString() + "1." + ret[1].ToString();
            ...
            else if (!(string.IsNullOrEmpty(lnkDownload1.Text.ToString())))
            {
                imagePath1 = lnkDownload1.Text.ToString();
            }
            else
            {
                lblStatus.Text = "The Image 1 shouldn't be empty";
                return;
            }
            if (!(string.IsNullOrEmpty(FileImage2.FileName.ToString())))
            {
                ...
                downfile = cboBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + cboModel.SelectedValue.ToString() + "2." + ret[1].ToString();
            ...
            if (!(string.IsNullOrEmpty(FileImage3.FileName.ToString())))
            {
                ...
                downfile = cboBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + cboModel.SelectedValue.ToString() + "3." + ret[1].ToString();
            ...
            if (!(string.IsNullOrEmpty(FileImage4.FileName.ToString())))
            {
                ...
                downfile = cboBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + cboModel.SelectedValue.ToString() + "4." + ret[1].ToString();
            ...
            if (!(string.IsNullOrEmpty(FileImage5.FileName.ToString())))
            {
                string downfile = string.Empty;
                string[] ret = FileImage2.FileName.Split('.');
                downfile = cboBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + cboModel.SelectedValue.ToString() + "5." + ret[1].ToString();
            ...
            if (reader.Read())
            {
                ...
                BusinessTier.DisposeReader(reader);
                flg = BusinessTier.ProductItem(conn, Convert.ToInt32(piid.ToString()), Convert.ToInt32(cboModel.SelectedValue.ToString().Trim()), Convert.ToInt32(txtTotalStock.Text.ToString()), imagePath1.ToString().Trim(), imagePath2.ToString().Trim(), imagePath3.ToString(), imagePath4.ToString(), imagePath5.ToString(), 1, Session["CustomerID"].ToString().Trim(), "U");
            }
            else
            {
                BusinessTier.DisposeReader(reader);
                flg = BusinessTier.ProductItem(conn, 1, Convert.ToInt32(cboModel.SelectedValue.ToString().Trim()), Convert.ToInt32(txtTotalStock.Text.ToString()), imagePath1.ToString().Trim(), imagePath2.ToString().Trim(), imagePath3.ToString(), imagePath4.ToString(), imagePath5.ToString(), 1, Session["CustomerID"].ToString().Trim(), "N");
            }
    ...
    protected void btnAddStock_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                lblGridStatus.Text = "Enter Size";
                lblGridStatus.ForeColor = Color.Red;
                return;
            }
            if (string.IsNullOrEmpty(txtStock.Text.ToString().Trim()))
            {
                lblGridStatus.Text = "Enter Stock";
                lblGridStatus.ForeColor = Color.Red;
                return;
            }
            int flg = 0;
