...
<!-- End Google Tag Manager -->
    <title>EasyBuyBye | Wishlist </title>
                  ...
                  <div class="privacy about">
                    <%-- <h3>Wish<span>list</span></h3>--%>
                     <div class="checkout-right">
                        <h4>Your Wishlist Contains: <span><%= dtGridVal.Rows.Count %> Products</span></h4>
                        <%                           
                              ...
                              <tr class="rem1">
                                 ...
                                 <td class="invert">                                    
                                       <div class="quantity-select" style="text-align:center">                                      
                                            <asp:HiddenField ID="hdWishlistID" runat="server" Value='<%# Eval("WishlistID")%>'/>
                                            <asp:HiddenField ID="hdProductID" runat="server" Value='<%# Eval("ProductID")%>'/>
                                            <asp:HiddenField ID="hdTotalStock" runat="server" Value='<%# Eval("TotalStock")%>'/>                                             
                                          <div>                                          
                           <asp:LinkButton style="float:none;" ID="lbplus" CommandName="plus" runat="server" class="entry value-plus active"></asp:LinkButton>
                           <asp:Label ID="lblsoldout" runat="server" Text="SoldOut"></asp:Label>
                           </div>                                         
                                       </div>                                    
                                 </td>
                                 <td class="invert"><%# DataBinder.Eval(Container.DataItem, "Brand")%>&nbsp;<%# DataBinder.Eval(Container.DataItem, "Model")%></td>
                                 <td class="invert">RM <%# DataBinder.Eval(Container.DataItem, "DiscountPrice")%></td>
                                 <td class="invert">
                                    <div>
                                       <div><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/web/images/close_1.jpg" CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete ?');"/> </div>
                                    </div>
                                 </td>
                              </tr>                             
                           </tbody>
