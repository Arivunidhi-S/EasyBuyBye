<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyDeals.aspx.cs" Inherits="MonthlyDeals" %>
...
<html>
<head>
    <title>EasyBuyBye | Monthly Deals </title>
...
<body>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            <h3>
           <% =DateTime.Now.ToString("MMMM") %> Deals 
            </h3>
            <!--/w3_short-->
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" ChildrenAsTriggers="true"
                        ...
                        <ContentTemplate>  
                            ...
                            <asp:DropDownList ID="cboSortby" runat="server" Height="25px" class="frm-field sect"
                                ...
                                <asp:ListItem Text="Order By Latest" Value="Latest"></asp:ListItem>
                                <asp:ListItem Text="Order By Category" Value="Category"></asp:ListItem>
                                <asp:ListItem Text="Price(High - Low)" Value="desc"></asp:ListItem>
                                <asp:ListItem Text="Price(Low - High)" Value="asc"></asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <div class="clearfix">
