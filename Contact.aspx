...
<!-- End Google Tag Manager -->
    <title>EasyBuyBye | Contact Us </title>
            ...
            <div class="agile-contact-grids">
                <div class="agile-contact-left">
                    ...
                    <div class="col-md-6 contact-form">
                        <h4 class="black-w3ls">
                            Contact  <span>Us</span></h4>
                        <div class="styled-input agile-styled-input-top">
                             <asp:TextBox ID="txtContactName" runat="server" class="textbox" onkeyup="checkchar(this);" ToolTip="You don't use Special Character like ' \ / : * ? ~ ` < > | . ''"></asp:TextBox>
                            <label>
                                Name</label>
                            <span></span>
                        </div>
                        <div class="styled-input">
                         ...
                         <div class="styled-input">
                           <asp:TextBox ID="txtSubject" runat="server" class="textbox" onkeyup="checkchar(this);" ToolTip="You don't use Special Character like ' \ / : * ? ~ ` < > | . ''"></asp:TextBox>
                            <label>
                                Subject</label>
                            <span></span>
                        </div>
                         <div class="styled-input">
                          <asp:TextBox ID="txtMessage" runat="server" TextMode="MultiLine" Height="100px" class="textbox" ToolTip="You don't use Special Character like ' \ / : * ? ~ ` < > | . ''"></asp:TextBox>
                            <label>
                                Message</label>
                            <span></span>
                        </div>  
                        ...
                        <span>
                                  <asp:Label ID="lblStatus" runat="server" Text="" ForeColor="Red"></asp:Label> <div class="clearfix">
                </div>
