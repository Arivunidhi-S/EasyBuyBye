    ...
    protected void btnSignin_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (reader1.Read())
            {
                ...
                string BusinessID = reader1["BusinessID"].ToString();
                ...
                Response.Redirect("Addcart.aspx?Param=" + BusinessID.ToString() + "&Param2=" + Request.Cookies["BDID"].Value.ToString(), false);
            ...
            {
                lblLogStatus.Text = "** Login Failed. Invalid Username (or) Password **";
            }
            //}
        }
        catch (Exception ex)
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (BusinessID == 0)
                    {
                        ...
                        msg = msg + "<br><div style='width:100%; text-align:left'>To sign into your account, please use this email address. <br> Your temporary password is :<b style='background: Yellow;'>12345</b><br> We recommend you change your password immediately.<br><br></div>"; 
                        msg = msg + "<p>If you need help at any point during your shopping journey with us, please do not hesitate to get in touch immediately. Our most up-to-date contact details are posted on our website. We’re here for you and we’re glad to have you with us. (Don’t forget to change your password, ok?)</p>";
                        ...
                        BusinessTier.SendMail(txtEmail.Text.ToString(), "Thank you for using EasyBuyBye Express Checkout!.", msg, 1);
                    }
                    BusinessTier.ExpressBuy(conn, txtName.Text.ToString().Trim(), txtMobile.Text.ToString(), txtEmail.Text.ToString(), txtAddress1.Text.ToString().Trim(), txtAddress2.Text.ToString().Trim(), "", txtPostCode.Text.ToString().Trim(), txtCity.Text.ToString().Trim(), txtState.SelectedItem.Text.ToString().Trim(), txtCountry.SelectedItem.Text.ToString().Trim(), "N");
