...
public partial class MasterProduct : System.Web.UI.Page
{
    ...
    protected void btnAddProduct_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string downfile = txtBrand.Text.ToString() + Session["CustomerID"].ToString().Trim() + txtModel.Text.ToString() + "." + ret[1].ToString();
    ...
    //    {
    //        lblStatus.Text = "Enter Price";
    //        lblStatus.ForeColor = Color.Red;
    //        return;
    //    }
    //    decimal p = 0, r = 0, per = 0;
    //    p = Convert.ToDecimal(txtSellingPrice.Text.ToString().Trim());
    //    r = Convert.ToDecimal(txtDiscount.Text.ToString().Trim());
    //    per = p - ((r / 100) * p);
    //    txtDiscountPrice.Text = per.ToString("#.##");
    //}
