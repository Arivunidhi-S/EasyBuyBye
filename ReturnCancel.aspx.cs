...
public partial class ReturnCancel : System.Web.UI.Page
{
    ...
    public void gridload()
    {
        try
        {
            ...
            conn.Open();
            string sql = BusinessTier.getReturnCancel(condition, Request.Cookies["CustomerID"].Value.ToString());
    ...
    protected void rpCheckout_ItemDataBound(object source, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            {
                lblShipped.ForeColor = Color.Red;               
