                        ...
                        <div class="contact-form1">
                                ...
                                <span>
                                    <label>
                                        Categories</label></span> <span>
                                            ...
                                            <telerik:RadComboBox ID="cboCategories" runat="server" Width="300px" DropDownWidth="300px" Skin="Sunset"
                                                DataValueField="CategoryID" CssClass="test" EnableLoadOnDemand="true" AppendDataBoundItems="True"
                            ...
                            <div>
                                <span>
                                     <label style="float: left;padding-right:3px">
                                        Brand</label> &nbsp;<img title="You don't use Special Character like ' \ / : * ? ' < > | '"
                                            src="images/q.jpg" style="float:left" alt=""/></span> <span>
                                            <asp:TextBox ID="txtBrand" runat="server" class="textbox"></asp:TextBox>
                                        </span>
                            </div>
                            <div>
                                <span>
                                     <label style="float: left;padding-right:3px">
                                        Model</label>&nbsp;<img title="You don't use Special Character like ' \ / : * ? ' < > | '"
                                            src="images/q.jpg" style="float:left" alt=""/></span> <span>
                                            <asp:TextBox ID="txtModel" runat="server" class="textbox"></asp:TextBox></span>
                            </div>
                            <div>
                                <span>
                                    <label>
                            ...
                            <div>
                             ...
                             <div>
                                <span>
                                    <label>
                                       Visible in Singapore</label></span> <span>
                                           <asp:CheckBox ID="chkSingapore" runat="server" />  
                                            </span>
                            </div>
                               <div>
                                <span>
                                    <label>
                                       SG Cut Price</label></span> <span>
                                          
                                            <asp:TextBox ID="txtSGCutPrice" runat="server" class="textbox" onkeyup="checkDec(this);"></asp:TextBox></span>
                            </div>
                    ...
                    <div class="grid_1_of_3 images_1_of_3">
                        <div class="contact-form1">
                         <div>
                                <span>
                                    <label>
                                       SG Price</label></span> <span>
                                          
                                            <asp:TextBox ID="txtSGPrice" runat="server" class="textbox" onkeyup="checkDec(this);"></asp:TextBox></span>
                            </div>
                            <div>
                                <span>
                                    <label>
                                ...
                                <span>
                                    <label>
                                        Weight(In Grams)</label></span> <span>
                                            <asp:TextBox ID="txtWeight" runat="server" class="textbox" onkeyup="checkDec(this);"></asp:TextBox></span>
                            </div>
                            <div>
                                <span>
                                    <label>
                                        URL</label></span> <span>
                                            <asp:TextBox ID="txtURL" runat="server" class="textbox"></asp:TextBox>
                                        </span>
                            </div>
                            <div>
                                <span>
                                    <label>
                                        Supplier</label></span> <span>
                                            ...
                                            <telerik:RadComboBox ID="cboSupplier" runat="server" Width="300px" DropDownWidth="300px" Height="250px"
                                                DataValueField="SupplierID" CssClass="test" EnableLoadOnDemand="true" AppendDataBoundItems="True"
                                                EmptyMessage="Select Supplier" OnItemsRequested="cboSupplier_OnItemsRequested" Skin="Sunset">
                                                <Items>
                                                </Items>
                                            </telerik:RadComboBox>
                                        </span>
                                    ...
                                    <label>
                                        CatalogName</label></span> <span>
                                           <%-- <asp:TextBox ID="txtCatalogName" runat="server" class="textbox" TextMode="MultiLine"
                                                ...
                                                Width="300px" AutoPostBack="false" DropDownWidth="300px" AppendDataBoundItems="true" Skin="Sunset"
                                                EmptyMessage="Select Catalog" OnItemsRequested="txtCatalogName_OnItemsRequested" Height="250px">
                                                <Items>
                                                    <%--  <!-- #Include file="web/IncludecboCatagery.html" -->--%>
                                                </Items>
                                            </telerik:RadComboBox>
                            ...
                            <div>
                                <span>
                                    <asp:Button ID="Button1" runat="server" Text="Add Product" OnClick="btnAddProduct_OnClick" /> <asp:Button ID="btnNext" runat="server" Text="Next" OnClick="btnNext_OnClick" /></span>
                            </div>
                            <div>
                                <span>
                                    <label>
