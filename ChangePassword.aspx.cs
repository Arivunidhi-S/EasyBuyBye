...
public partial class ChangePassword : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string tablename = string.Empty, field = string.Empty;
            if (@Param1 == "b") { tablename = "BusinessRegister"; field = "BusinessID"; } else { tablename = "SellerRegister"; field = "SellerID"; }
            SqlDataReader reader = BusinessTier.FindDublicate(connMenu, tablename, field, @Param.ToString().Trim());
            ...
            if (reader.Read())
            {
                ...
                if (@Param1 == "f")
                {
                    lblsysregno.Text = Email.ToString();
        ...
        {
            InsertLogAuditTrail("1", "ChangePassword", "btnChangePassword_OnClick", ex.ToString(), "Audit");
        }
        finally
        {
            BusinessTier.DisposeConnection(connMenu);
    ...
    protected void btnChangePassword_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                lblStatus.Text = "** Password cannot be Empty. Please enter Valid Password**";
            ...
            if (@Param1 == "s")
            {
                sql = "update SellerRegister set Password='" + txtPassword.Text.ToString() + "' where SellerID='" + @Param.ToString() + "' and  deleted=0";
            }
            else if (@Param1 == "b")
            {
                sql = "update BusinessRegister set Password='" + txtPassword.Text.ToString() + "' where BusinessID='" + @Param.ToString() + "' and  deleted=0";
            }
