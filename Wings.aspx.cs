...
public partial class Wings : System.Web.UI.Page
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>window.open('https://www.m.easybuybye.com/wings','_self');</script>");
        }
    }
