...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            <h3>
                <%= dtRecentitems.Rows[0][10].ToString().Trim()%>
                <%--<span>Page </span>--%>
            </h3>
            <!--/w3_short-->
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    <ul class="w3_short">
                        <li><a href="index.aspx">Home</a><i>|</i></li>
                         <li><a href='AllProducts.aspx?Basic=<%= dtRecentitems.Rows[0][12].ToString()%>&Sub=0'>
                            <%= dtRecentitems.Rows[0][14].ToString()%></a><i>|</i></li>
                        <li><a href='AllProducts.aspx?Basic=0&Sub=<%= dtRecentitems.Rows[0][13].ToString()%>'>
                            <%= dtRecentitems.Rows[0][15].ToString()%></a><i>|</i></li>
                        <li>
                            <%= dtRecentitems.Rows[0][10].ToString()%></li>
            ...
            <div class="sort-grid">
                <div class="sorting">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" ChildrenAsTriggers="true"
                        ...
                        <ContentTemplate>
                         <h6>
                                <asp:Label ID="lblSize" runat="server" Text="Size"></asp:Label></h6>
                          <asp:DropDownList ID="cboSize" runat="server" Height="25px" class="frm-field sect"
                                Style="height: 35px" AutoPostBack="true" OnSelectedIndexChanged="cboSize_SelectedIndexChanged">
                                ...
                                <asp:ListItem Text="XXL" Value="4"></asp:ListItem>
                                <asp:ListItem Text="3XL" Value="5"></asp:ListItem>
                            </asp:DropDownList>
                           <%-- <h6>
                                Brand</h6>
                            <asp:DropDownList ID="cboCategories" runat="server" Height="25px" class="frm-field sect"
                                Style="height: 35px" EnableViewState="true" AutoPostBack="true" OnSelectedIndexChanged="cboCategories_SelectedIndexChanged">
                            </asp:DropDownList>--%>
                            <h6>
                                &nbsp;&nbsp;&nbsp;Sort By</h6>
