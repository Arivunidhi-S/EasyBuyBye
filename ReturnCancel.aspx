<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnCancel.aspx.cs" Inherits="ReturnCancel" %>
...
<html>
<head>
    <title>EasyBuyBye | Return/Cancel </title>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" ChildrenAsTriggers="true"
                        ...
                        <ContentTemplate>  
                            ...
                            <asp:DropDownList ID="cboSortby" runat="server" Height="25px" class="frm-field sect"
                                ...
                                <asp:ListItem Text="Last 5 Return/Cancel" Value="5"></asp:ListItem>
                                <asp:ListItem Text="Last 10 Return/Cancel" Value="10"></asp:ListItem>
                                <asp:ListItem Text="Last 25 Return/Cancel" Value="25"></asp:ListItem>
                                <asp:ListItem Text="All Return/Cancel" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <div class="clearfix">
         ...
         <HeaderTemplate>
                           ...
                           <tbody>
                              <tr class="rem1">
                                 ...
                                 <td class="invert"><asp:Label ID="lblShipped" runat="server" Text='<%# Eval("Returncancel")%>'></asp:Label></td>
                        ...
                        <FooterTemplate>
                           ...
                           <% }
                            ...
                            {%>   <h4>No Return/Cancel Records Found</h4><%} %>
                     </div>                    
                  </div>
                   </ContentTemplate>
                    </asp:UpdatePanel>
