...
<html>
<head>
    <title>EasyBuyBye | Address </title>
                     ...
                     <div class="checkout-left">
                       ...
                       <asp:Repeater ID="rpAddress"  runat="server" OnItemCommand="rpAddress_ItemCommand" OnItemDataBound="rpAddress_OnItemDataBound">
                         ...
                         <div>       <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always" ChildrenAsTriggers="true" EnableViewState="true">
                                       ...
                                       <asp:HiddenField  ID="hdDefault" runat="server" Value='<%# Eval("DefaultAddress")%>'/>
                                       <asp:ImageButton id="btnAddressID" runat="server" style="float:none" ImageUrl="~/web/images/Default.png" ToolTip="Default" CommandName="Default" CssClass="" BorderStyle="None"/>	
                                       <asp:ImageButton id="btnEdit" runat="server" style="float:none" ImageUrl="~/web/images/Edit.png" CommandName="Select" ToolTip="Edit" CssClass="" BorderStyle="None"/>	
                                       <asp:ImageButton id="btnDelete" runat="server" style="float:none" ImageUrl="~/web/images/Delete.png" CommandName="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this data?');" CssClass="" BorderStyle="None"/>						      
                                               </ContentTemplate>
                                        </asp:UpdatePanel>                                                                           
                                <i><b >Address&nbsp;<%# Container.ItemIndex + 1 %> <asp:Label ID="lblDefault" runat="server" Text="(Default)" Visible="false"></asp:Label><br /></b></i>   </div>  
...
<%--                               <Triggers>
                                  <asp:AsyncPostBackTrigger ControlID="btnBye" EventName="Click"/> 
                                </Triggers>--%>
                                        </asp:UpdatePanel>                        
                        </div>
