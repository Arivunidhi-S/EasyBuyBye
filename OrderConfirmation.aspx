...
<!-- End Facebook Pixel Code -->
    ...
    <title>EasyBuyBye | Order Confirmation </title>
                  ...
                  <div class="privacy about">                   
                    ...
                    <asp:Label ID="lblordertitle" runat="server" Text="Order No : " Style="font-size: large"
                        ForeColor="Black" CssClass="lblfont"></asp:Label><span>
                            <asp:Label ID="lblOrderno" runat="server" Text="" Style="font-size: large" CssClass="lblfont"
                                ForeColor="Black"></asp:Label></span>                   
                </div>
                <br />
                <div>
                    <span>
                        <asp:Label ID="lblstatus" runat="server" Text="" Style="font-size: large" ForeColor="Black"
                            CssClass="lblfont"></asp:Label></span>
                </div>
                     <div class="checkout-left"> 
                                 <div class="col-md-8 checkout-left-basket">
                           <h4>Order Summary</h4>    
                        <div class="checkout-right">                          
                        <asp:Repeater ID="rpCheckout"  runat="server" OnItemDataBound="rpAddress_OnItemDataBound">
          <HeaderTemplate>
                           ...
                           <tbody>
                              <tr class="rem1">
                                            ...
                                            <asp:HiddenField ID="hdQnty" runat="server" Value='<%# Eval("Qnty")%>'/>
                                            <asp:HiddenField ID="hdPrice" runat="server" Value='<%# Eval("DiscountPrice")%>'/>
                                ...
                                <td class="invert"><%# DataBinder.Eval(Container.DataItem, "Brand")%>&nbsp;<%# DataBinder.Eval(Container.DataItem, "Model")%></td>
                                 <td class="invert">
                                    <div >
                                     <%# DataBinder.Eval(Container.DataItem, "Qnty")%>
                                    </div>
                                 </td>                                 
                                 <td class="invert"> <asp:Label ID="lblProductPrice" runat="server" ></asp:Label>  <%--RM <%# DataBinder.Eval(Container.DataItem, "DiscountPrice")%>--%></td>
                       ...
                       <div>
                        ...
                        Subtotal :
                                    <asp:Label class="labelstyle" ID="lblSubTotal" runat="server" ForeColor="Red" /><br />
                                    <br /> 
                                    Shipping Fee :
                                    <asp:Label class="labelstyle" ID="lblShippingCost" runat="server" ForeColor="Red" /><br />
                                    <br />
                                     Total :
                                    <asp:Label class="labelstyle" ID="lblTotal" runat="server" ForeColor="Red" /><br />
                                    <br />
                                    <asp:Label class="labelstyle" ID="lblPRA" runat="server" ForeColor="Black"  />
                                    <asp:Label class="labelstyle" ID="lblpromotion" runat="server" ForeColor="Red"  />                                    
                                    <asp:Label class="labelstyle" ID="lblGtotal" runat="server" ForeColor="Black" />
                                    <asp:Label class="labelstyle" ID="lblGrandTotal" runat="server" ForeColor="Red"  /> <br /><br />     
                         <asp:Button CssClass="buybutton" runat="server" id="btnBuy" Text="Buy More" OnClick="btnMoreBuy_Click" BorderStyle="None" /> 
                        </div>
                                 </div>                   
                        </div> 
